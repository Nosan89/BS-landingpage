...
import { Trophy, Stethoscope, Dumbbell, LayoutDashboard } from 'lucide-react'
import { useLang } from './LangContext'

const creds = [
  { icon: Trophy, cs: '2× Olympionik', en: '2× Olympian', descCs: 'Bobová dráha', descEn: 'Bobsled' },
  { icon: Stethoscope, cs: 'Fyzioterapeut (Bc.)', en: 'Physiotherapist (BSc.)', descCs: 'FTVS UK', descEn: 'Charles University' },
  { icon: Dumbbell, cs: 'S&C Coach', en: 'S&C Coach', descCs: 'Certifikovaný', descEn: 'Certified' },
  { icon: LayoutDashboard, cs: 'Vlastní platforma', en: 'Custom Platform', descCs: 'Postavená od nuly', descEn: 'Built from scratch' },
]
